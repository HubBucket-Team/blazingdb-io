...
namespace Library {
    namespace Logging {
        ...
        void BlazingLogger::logInfo(std::string&& logdata) {
            buildLogData(LoggingLevel::INFO, logdata);
        }
        ...
        void BlazingLogger::logWarn(std::string&& logdata) {
            buildLogData(LoggingLevel::WARN, logdata);
        }
        ...
        void BlazingLogger::logTrace(std::string&& logdata) {
            buildLogData(LoggingLevel::TRACE, logdata);
        }
        ...
        void BlazingLogger::logDebug(std::string&& logdata) {
            buildLogData(LoggingLevel::DEBUG, logdata);
        }
        ...
        void BlazingLogger::logError(std::string&& logdata) {
            buildLogData(LoggingLevel::ERROR, logdata);
        }
        ...
        void BlazingLogger::logFatal(std::string&& logdata) {
            buildLogData(LoggingLevel::FATAL, logdata);
        }
        ...
        void BlazingLogger::buildLogData(LoggingLevel level, const std::string& logdata) {
            ...
            buffer += ss.str();
            buffer += "][";
            buffer += getLevelName(level);
            buffer += "]";
            buffer += logdata;

            sendDataToService(buffer);
        }
