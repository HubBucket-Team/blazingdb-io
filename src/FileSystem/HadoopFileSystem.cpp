...
Path HadoopFileSystem::getRoot() const noexcept {
...
std::vector<std::string> HadoopFileSystem::listResourceNames(const Uri &uri, FileType fileType, const std::string &wildcard) const {
