...
Uri FileStatus::getUri() const noexcept {
	return this->uri;
}

FileType FileStatus::getFileType() const noexcept {
	return this->fileType;
}

unsigned long long FileStatus::getFileSize() const noexcept {
	return this->fileSize;
}

bool FileStatus::isFile() const noexcept {
