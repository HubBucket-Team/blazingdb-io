...
public:
	...
	static std::vector<std::string> splitNonQuotedKeepDelimiterInVector(std::string &input, std::vector<std::string> delimiters, char quoteChar, bool trimWhitespace);
	static std::vector<std::string> splitNonQuotedKeepDelimiterInVector(std::string &input, std::vector<std::string> delimiters, char quoteChar, bool trimWhitespace, bool respectDelimiterWhitespace);
	static bool isPositiveInteger(const std::string &);
	static std::string replaceNonQuotedChar(std::string textToSearch, std::string quoteChar, std::string charBeingSought, std::string replacingChar);
	static std::string replaceNonQuotedChar(std::string textToSearch, std::string quoteChar, std::vector<std::string> & charBeingSought, std::vector<std::string> & replacingChar);
	...
	static std::string replaceQuotedChar(std::string textToSearch, std::string quoteChar, std::string charBeingSought, std::string replacingChar);
...
//	static bool contains(std::string haystack,std::string needle);
	...
	static bool match(std::string & needle, std::string & haystack){
