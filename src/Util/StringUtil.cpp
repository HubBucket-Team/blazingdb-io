...
std::string StringUtil::removeEncapsulation(std::string s, std::vector<std::string> encapsulationPair){
	if (encapsulationPair.size() == 2){
		if(s.substr(0,encapsulationPair[0].size()) == encapsulationPair[0] && s.substr(s.size() - encapsulationPair[1].size(),encapsulationPair[1].size()) == encapsulationPair[1]){
...
std::string StringUtil::replaceNonQuotedChar(std::string textToSearch, std::string quoteChar, std::string charBeingSought, std::string replacingChar){
...
std::string StringUtil::replaceNonQuotedChar(std::string textToSearch, std::string quoteChar, std::vector<std::string> & charBeingSought, std::vector<std::string> & replacingChar){
...
std::string StringUtil::replaceQuotedChar(std::string textToSearch, std::string quoteChar, std::string charBeingSought, std::string replacingChar){
	std::vector<std::string> splitString = StringUtil::split(textToSearch,quoteChar);
...
std::vector<std::string> StringUtil::splitNonQuotedKeepDelimiterInVector(std::string &input, std::vector<std::string> delimiters, char quoteChar, bool trimWhitespace){
	return splitNonQuotedKeepDelimiterInVector(input, delimiters, quoteChar, trimWhitespace, false);
}

std::vector<std::string> StringUtil::splitNonQuotedKeepDelimiterInVector(std::string &input, std::vector<std::string> delimiters, char quoteChar, bool trimWhitespace, bool respectDelimiterWhitespace)
{
...
std::string StringUtil::NumberToString ( unsigned long long Number )
{

	 return std::to_string(Number);
}

std::string StringUtil::NumberToString ( double Number )
{

	 return std::to_string(Number);
}

std::string StringUtil::NumberToString ( float Number )
{

	 return std::to_string(Number);
}

  std::string StringUtil::NumberToString ( long long Number )
  {
...
bool StringUtil::bothAreSpaces(char lhs, char rhs) {
	return (lhs == rhs) && (lhs == ' ');
}
...
std::vector<std::string> StringUtil::splitNotInQuotes(std::string input, std::string delim, std::vector<bool> & quoted) {
